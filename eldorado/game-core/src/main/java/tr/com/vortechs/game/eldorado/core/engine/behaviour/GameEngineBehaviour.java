package tr.com.vortechs.game.eldorado.core.engine.behaviour;
...
public interface GameEngineBehaviour<C extends AbstractGameContext,B extends AbstractBeanContext,S extends AbstractGameSettings,P extends AbstractGamePlayer> extends AbstractGameBehaviour{
	 void engineBehave(C context,B beans,S settings,P player);
